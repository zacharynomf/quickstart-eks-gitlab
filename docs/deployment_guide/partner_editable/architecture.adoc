...
A cron expression controls the backup schedule and the default value is `pass:[0 1 * * * *]` (daily at 1:00 AM). You can set a different schedule using the *BackupSchedule* parameter.
