...
:launch_link_existing_cluster: https://fwd.aws/wrQba?
:template_link_existing_cluster: https://github.com/aws-quickstart/quickstart-eks-gitlab/blob/main/templates/gitlab-entry-existing-cluster.template.yaml
